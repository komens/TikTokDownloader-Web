...
PROJECT_NAME = f"TikTokDownloader-Web V{__VERSION__}"

# 本项目为 TikTokDownloader 的二次开发版本，原始项目仓库如下
UPSTREAM_REPOSITORY = "https://github.com/JoeanAmier/TikTokDownloader"
REPOSITORY = "https://github.com/komens/TikTokDownloader-Web"
LICENCE = "GNU General Public License v3.0"
DOCUMENTATION_URL = "https://github.com/komens/TikTokDownloader-Web#readme"
RELEASES = "https://github.com/komens/TikTokDownloader-Web/releases/latest"

DISCLAIMER_TEXT = (
    "关于 TikTokDownloader-Web 的 免责声明：\n"
    "\n"
    ...
    "10. 本项目是基于 TikTokDownloader（原作者 JoeanAmier，https://github.com/JoeanAmier/TikTokDownloader ）的二次开发版本。基于本项目进行的任何二次开发、修改或编译的程序与原创作者无关，原创作者不承担与二次开发行为或其结果相关的任何责任，使用者应自行对因二次开发可能带来的各种情况负全部责任。\n"
